...
use App\Http\Controllers\Site\RegistrationForm\RegistrationStoreController;
...
Route::post('site/registration-store', RegistrationStoreController::class)->name('site.registration-store');
