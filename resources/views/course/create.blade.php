                    ...
                    <div class="mb-3 col-md-12">
                        <div class="mb-3">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="feeType" onclick="javascript:check();" id="paid" value="paid" />
                                <label class="form-check-label" for="paid">Paid</label>
                            </div>

                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="feeType" onclick="javascript:check();" id="free" value="free" />
                                <label class="form-check-label" for="free">Free</label>
                            </div>
                        </div>

                        <div class="col-md-2" id="show" style="visibility:hidden">
                            <input type="number" class="form-control" min="0" name="feeAmount" placeholder="enter amount" />
                        </div>
                    </div>
